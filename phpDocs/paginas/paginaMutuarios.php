...
<head>
    ...
    <title>Mutuários - COHAB Minas</title>
    ...
    <main>
        <section class="hero" aria-label="Destaque principal">
            ...
            <div class="hero-content">
                ...
                <h1 class="hero-title">Direito à casa, Direito à vida.</h1>
                <div class="hero-cta-stack">
                    <a class="btn-brilhante" href="#conteudo">Serviços ao Mutuário</a>
                    <div class="acessos-rapidos" aria-label="Acesso rapido aos servicos">
                        <a class="acesso-rapido" data-label="2ª via de boleto" href="../MenuHorizontal/Mutuarios/segundaViaBoletos.php" target="_blank" rel="noopener">
                            <img src="../imagens/menuScroll/boleto.svg" alt="2ª via de boleto">
                            <span>2ª via de boleto</span>
                        </a>
                        <a class="acesso-rapido" data-label="Escrituras" href="../MenuHorizontal/Mutuarios/escrituras.php" target="_blank">
                        ...
                        <a class="acesso-rapido" data-label="Seguro" href="../MenuHorizontal/Mutuarios/seguros.php" target="_blank">
                            <img src="../imagens/menuScroll/seguro.svg" alt="Seguro">
                            <span>Seguro</span>
                        </a>
                    </div>
                </div>
        ...
        <section class="servicos-destaque" aria-label="Servicos mais acessados">
            ...
            <div class="servicos-grid">
                <a class="servico-card" href="../MenuHorizontal/Mutuarios/segundaViaBoletos.php" target="_blank" rel="noopener">
                    <img src="../imagens/menuScroll/boleto.svg" alt="Segunda via de boletos">
                    <span>Segunda via de boletos</span>
                    <p class="servico-desc">Emita seu boleto atualizado em poucos passos.</p>
                </a>
                <a class="servico-card" href="../MenuHorizontal/Mutuarios/escrituras.php" target="_blank">
                    <img src="../imagens/menuScroll/escrituras.svg" alt="Escrituras">
                    <span>Escrituras</span>
                    <p class="servico-desc">Saiba mais sobre as Escrituras e outros documentos do Mutuário e da COHAB Minas.</p>
                </a>
                <a class="servico-card" href="../MenuHorizontal/Atendimento/perguntas.php" target="_blank">
                    <img src="../imagens/menuScroll/perguntas.svg" alt="Perguntas frequentes">
                    <span>Perguntas frequentes</span>
                    <p class="servico-desc">Dúvidas recorrentes sobre todos processos da COHAB Minas.</p>
                </a>
                ...
                <a class="servico-card" href="../MenuHorizontal/Mutuarios/seguros.php">
                    <img src="../imagens/menuScroll/seguro.svg" alt="Seguro">
                    <span>Seguro</span>
                    <p class="servico-desc">Saiba Mais sobre o Seguro de Residência da COHAB Minas.</p>
