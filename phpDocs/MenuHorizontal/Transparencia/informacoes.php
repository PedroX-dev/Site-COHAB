...
<head>
    ...
    <title>Informações Classificadas e Desclassificadas</title>
...
<main class="centralizarX">
        <span id="titulo">Informações Classificadas e Desclassificadas</span>
        <hr>
        <p>
            <img src="imagens/informacoes.png" alt="Informações Classificadas e Desclassificadas">
            <br>
            Em atendimento ao disposto no art. 46 do Decreto Estadual nº 45.969/2012, a Companhia de Habitação do Estado de Minas Gerais informa que não teve informações classificadas ou desclassificadas nos graus de sigilo reservado, secreto ou ultrassecreto, até a data 04/06/2025.
            <br><br>
            As estatísticas referentes à Lei de Acesso à Informação podem ser acessadas por meio do seguinte endereço:
            <br><br>
            <a href="https://acessoainformacao.mg.gov.br/sistema/site/index.aspx" target="_blank">acessoainformacao.mg.gov.br</a>
        </p>
        <hr>
    </main>
