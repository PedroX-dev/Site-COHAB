...
<main class="centralizarX">
        <span id="titulo">Licitações</span>
        <hr>

        <section class="licitacoes-container">
            <div class="licitacoes-intro">
                <p>Consulte abaixo as contratações da Cohab Minas.</p>
                <p>Para consulta aos processos de dispensa, inexigibilidade de licitação e licitatórios anteriores a 2018, favor entrar em contato pelo e-mail:
                    <a href="mailto:licitacao@cohab.mg.gov.br">licitacao@cohab.mg.gov.br</a>.
                </p>
            </div>

            <div class="licitacoes-layout">
                <div class="licitacoes-card">
                    <h2>Escolha o tipo de procedimento e/ou situação.</h2>
                    <p class="licitacoes-subtitle">Para melhorar a busca, selecione os demais filtros.</p>

                    <form class="licitacoes-form" id="form-licitacoes" method="get" action="#">
                        <label class="licitacoes-field" for="tipo_procedimento">
                            ...
                            <select name="tipo_procedimento" id="tipo_procedimento">
                                ...
                                <option value="Dispensa de Licitação por Valor">Dispensa de Licitação por Valor</option>
                                <option value="Inexigibilidade Licitação">Inexigibilidade Licitação</option>
                                <option value="Outras Dispensas de Licitação">Outras Dispensas de Licitação</option>
                                <option value="Pregão Eletrônico">Pregão Eletrônico</option>
                                <option value="Pregão Eletrônico Registro de Preços">Pregão Eletrônico Registro de Preços</option>
                                <option value="Pregão Presencial">Pregão Presencial</option>
                                <option value="Proced. Seleção. PMCMV">Proced. Seleção. PMCMV</option>
                                <option value="Proced. das Estatais Eletrônico">Proced. das Estatais Eletrônico</option>
                                <option value="Proced. das Estatais Presencial">Proced. das Estatais Presencial</option>
                            </select>
                        </label>

                        <label class="licitacoes-field" for="situacao">
                            <span>Situação</span>
                        ...
                        <label class="licitacoes-field" for="resultado" id="resultado-container" hidden>
                            <span>Resultado</span>
                        ...
                        <label class="licitacoes-field" for="criterio">
                        ...
                        <label class="licitacoes-field" for="ano">
                            <span>Ano</span>
                        ...
                        <label class="licitacoes-field" for="palavra_chave">
                            <span>Palavra-chave</span>
                            <input type="text" name="palavra_chave" id="palavra_chave" placeholder="Digite uma palavra-chave" />
                        </label>

                        <div class="licitacoes-actions">
                            <button type="submit" class="btn-acao">Pesquisar</button>
                            <button type="button" class="btn-acao btn-secundario" id="limpar-filtros">Limpar Filtros</button>
                        </div>
                    </form>
                </div>

                <div class="licitacoes-results">
                    <div class="licitacoes-results-header">Compras e Licitações</div>
                    <div class="licitacoes-results-body">
                        <p>Use os filtros de busca para ver os resultados aqui.</p>
                    </div>
                </div>
            </div>
        </section>
