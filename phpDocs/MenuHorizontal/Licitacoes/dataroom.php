...
<main id="justificar">
        <span id="titulo">Data Room</span>
        <hr>
        <p>
            O <b>Data Room</b> da Cohab Minas é uma sala de dados disponível para <b>empresas interessadas em participar de procedimentos licitatórios da Companhia</b>, nos quais é imprescindível o conhecimento de dados e processos internos da Cohab Minas.
            <br><br>
            As informações estão em conformidade com a <b>Lei Geral de Proteção de Dados Pessoais (Lei Nº 13.709/2018)</b> e são acessíveis por pessoas jurídicas mediante assinatura de Acordo de Confidencialidade, demonstração de interesse comercial à licitação e atendimento às qualificações técnicas da licitação em propositura.
            <br><br>
            Para solicitar acesso, a empresa interessada deverá:
                <br><br>
                Acessar o link: <a href="https://dataroom.cohab.mg.gov.br/">dataroom.cohab.mg.gov.br</a>;
                <br>
                Clicar em <b>“Acessar Agora”</b>;
                <br>
                Depois em <b>“Registre-se”</b>;
                <br>
                Registrar seu e-mail corporativo e senha, e após isso clicar em “Registrar”;
                <br><br>  
            Dessa forma, deve-se aguardar a aprovação do login pela equipe responsável, bem como contato por e-mail com as instruções para assinatura do Acordo de Confidencialidade.
        </p>
        <hr>
    </main>
