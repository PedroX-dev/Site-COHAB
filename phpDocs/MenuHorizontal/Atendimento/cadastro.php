...
<head>
    ...
    <title>Cadastro de Reserva de Imóvel Cohab Minas</title>
...
<main class="centralizarX">
        <span id="titulo">Cadastro de Reserva de Imóvel Cohab Minas</span>
        <hr>
        <p>
            O <b class="negrito-azul">cadastro</b> é para eventual oferta de <b class="negrito-azul">compra e venda de imóveis</b> em sua cidade.
            <br><br>
            <i>Tão logo seja disponibilizado algum imóvel no município de V.Sa. todos os cadastrados serão convocados para ofertarem suas propostas de compra.</i>
            <br><br>
            Mantenha seu cadastro sempre atualizado e não se esqueça de que este cadastro não gera prioridade e nem garantia de aquisição de uma unidade habitacional a ser comercializada pela Cohab Minas.
            <br><br>
            <h4 class="negrito-azul">Faça aqui o seu cadastro de reserva:</h4>
            <b> (Não se esqueça de anotar seu número de cadastro / protocolo).</b>
        </p>
        <form class="cadastro-form" action="#" method="post">
            <div class="form-section">
                <h3>Cadastro</h3>
                <div class="form-grid">
                    <label for="codigo-usuario">Codigo Usuario (Auto)</label>
                    <input id="codigo-usuario" name="codigo_usuario" type="text" value="20205055" readonly>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <select id="genero" name="genero" required>
                        ...
                        <option value="nao_informar">Prefiro nao informar</option>
                    </select>

                    <label for="data-nascimento">Data de Nascimento *</label>
                    <input id="data-nascimento" name="data_nascimento" type="date" required>

                    <label for="cpf">CPF *</label>
                    <input id="cpf" name="cpf" type="text" required>

                    <label>Servidor publico ou empregado publico estadual?</label>
                    <div class="radio-group">
                        <label><input type="radio" name="servidor_publico" value="sim" required> Sim</label>
                        <label><input type="radio" name="servidor_publico" value="nao"> Nao</label>
                    </div>

                    <label for="identidade">Identidade *</label>
                    <input id="identidade" name="identidade" type="text" required>

                    <label for="orgao-expedidor">Órgão Expedidor *</label>
                    <input id="orgao-expedidor" name="orgao_expedidor" type="text" required>

                    <label for="celular">Celular *</label>
                    <input id="celular" name="celular" type="tel" required>

                    <label for="telefone">Telefone contato (fixo ou celular)</label>
            ...
            <div class="form-section">
                <h3>Complementos</h3>
                <div class="form-grid">
                    <label>Tem filhos / dependentes *</label>
                    <div class="radio-group">
                        <label><input type="radio" name="dependentes" value="sim" required> Sim</label>
                        <label><input type="radio" name="dependentes" value="nao"> Nao</label>
                    </div>

                    <label for="dependentes-quantidade" class="dependentes-field hidden">Numero de dependentes *</label>
                    <input id="dependentes-quantidade" class="dependentes-field hidden" name="dependentes_quantidade" type="number" min="0" step="1">

                    <label for="nome-mae">Nome da Mae do Candidato *</label>
                    <input id="nome-mae" name="nome_mae" type="text" required>

                    <label for="profissao">Profissao *</label>
                    <input id="profissao" name="profissao" type="text" required>

                    <label for="renda">Renda Bruta *</label>
                    <input id="renda" name="renda_bruta" type="text" required>
                </div>
            </div>

            <div class="form-section">
                <h3>Endereco Residencial</h3>
                <div class="form-grid">
                    <label for="endereco1">Endereco Residencial *</label>
                    <input id="endereco1" name="endereco1" type="text" required>

                    <label for="cidade1">Cidade</label>
                    <input id="cidade1" name="cidade1" type="text">

                    <label for="estado1">Estado</label>
                    <input id="estado1" name="estado1" type="text">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <label for="cidade-interesse">Cidade de Interesse para aquisicao do Imovel *</label>
                    <div class="combo-cidades">
                        <input id="cidade-interesse" name="cidade_interesse" type="text" autocomplete="off" required>
                        <div id="cidade-interesse-list" class="combo-list" role="listbox" aria-label="Cidades"></div>
                    </div>

                    <label>Possui imovel em seu nome? *</label>
                    <div class="radio-group">
                        <label><input type="radio" name="possui_imovel" value="sim" required> Sim</label>
                        <label><input type="radio" name="possui_imovel" value="nao"> Nao</label>
                    </div>

                    <label>Reside no imovel pretendido? *</label>
                    <div class="radio-group">
                        <label><input type="radio" name="reside_imovel" value="sim" required> Sim</label>
                        <label><input type="radio" name="reside_imovel" value="nao"> Nao</label>
                    </div>

                    <label for="tempo-residencia" class="residencia-field hidden">Tempo de residencia no imovel</label>
                    <input id="tempo-residencia" class="residencia-field hidden" name="tempo_residencia" type="text">
                </div>
            </div>

            <div class="form-section">
                <h3>Termo de Ciencia para Finalizar o Cadastro</h3>
                <div class="termo-texto">
                    <p>Pelo presente TERMO DE RESPONSABILIDADE, declaro para os devidos fins de direito, sob as penas da lei, que as informacoes acima prestadas sao verdadeiras, assumindo a inteira responsabilidade pelas mesmas, ciente de que a falsidade dessa declaracao configura crime previsto no Codigo Penal brasileiro e passivel de apuracao na forma da Lei.</p>
                    <p>Me comprometo a atualizar meus dados e informacoes, no site, sempre que acontecer qualquer alteracao e comunicar com o envio de e-mail ao seguinte endereco eletronico: contratacao@200.198.20.180, ciente de que qualquer inconsistencia, erro ou omissao encontrada, em especial do e-mail de contato fornecido, acarretara em perda de oportunidade por minha exclusiva culpa, ja que sou o unico responsavel pelo fornecimento das informacoes.</p>
                    <p>Estou ciente que o cadastro nao gera nenhum compromisso de oferta de imovel para a Companhia de Habitacao do Estado de Minas Gerais - Cohab Minas, nem mesmo garantia de que terei qualquer tipo de preferencia a aquisicao de imovel.</p>
                    <p>Por fim, declaro estar ciente de que e de minha inteira responsabilidade o acesso rotineiro ao e-mail utilizado no cadastrado e o cumprimento dos prazos para apresentacao de ofertas e, em caso de ter sido selecionado, para apresentacao da documentacao necessaria a habilitacao na oferta, inclusive de comprovacao de minha capacidade financeira para a respectiva aquisicao, sob pena de desclassificacao.</p>
                </div>

                <div class="form-grid">
                    <label>Concordar ou Discordar dos Termos *</label>
                    <div class="radio-group centralizarX">
                        <label><input type="radio" name="termo" value="concordo" required> Concordo</label>
                        <label><input type="radio" name="termo" value="discordo"> Discordo</label>
                    </div>
                </div>
            </div>
