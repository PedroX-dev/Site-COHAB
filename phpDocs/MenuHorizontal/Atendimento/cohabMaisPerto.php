...
<main>
        <span id="titulo">COHAB Mais Perto</span>
        <hr>
        <p class="centralizar-justificar">
            Em seus 60 anos de história, a <b> Cohab Minas construiu cerca de 1,3 mil conjuntos habitacionais em mais de 550 municípios mineiros.</b>
            Em um Estado com 853 cidades e contando com um quadro funcional reduzido,
            a Companhia encontrava dificuldades de estar presente em tantos conjuntos habitacionais para tratar diretamente com seus mutuários.
            Desta forma, com <b> o objetivo de levar um atendimento mais próximo aos munícipioss</b>, a empresa criou o Programa <b class="negrito-azul">Cohab Mais Perto</b>.
            O programa estabelece uma parceria entre a Companhia e as prefeituras mineiras, de forma a auxiliar, orientar, facilitar e promover 
            benefícios aos mutuários, nos empreendimentos construídos pela Cohab Minas nas cidades.
            <br><br>
        </p>
        <p class="centralizarX">
            Atualmente, a Companhia já estabeleceu parceria com 400 municípios de Minas.
            <br><a href="comoParticipar.php" target="_blank"> Clique Aqui</a> para saber como participar do programa.
            <br><br>
            Verifique no <b>Mapa Abaixo </b> ou pelo <a href="http://www.cohab.mg.gov.br/wp-content/uploads/2025/08/MUNICIPIOS_COHAB12.08.pdf" target="_blank"> acesse aqui </a> para visualizar os municípios participantes do Programa Cohab Mais Perto.
        </p>
        <br>
        <p class="centralizarX mapa-responsivo">
            <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1ijUJeuEn66LzUf-adtA2O7ZSCzR4s2s&ehbc=2E312F&noprof=1"></iframe>
        </p>
        <hr>
    </main>
