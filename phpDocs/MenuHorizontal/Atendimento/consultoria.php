...
<head>
    ...
    <title>Consultoria - COHAB Minas</title>
                    ...
                    <ul class="header-menu-list">
                        ...
                        <li class="header-menu-item">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="reurb.php">REURB</a></li>
...
<main id="justificar" class="reurb-page">
        <span id="titulo">Consultoria - COHAB Minas</span>
        <hr class="reurb-divider">
        <div class="cadastro-reserva">
            <a class="btn-reserva" href="imoveis.php" target="_blank" rel="noopener">
                Acessar Plataforma de Vendas Cohab Minas
            </a>
        </div>
        <section class="reurb-section">
            <h2>POR QUE CONTRATAR A COHAB MINAS?</h2>
            <p>Com mais de 60 anos de atuação e referência em políticas públicas habitacionais, a Cohab Minas é sinônimo de moradia digna.</p>
            <p>Sua expertise garante segurança jurídica, cumprimento de normas e execução eficiente dos projetos.</p>
            <p>Com equipe qualificada e atuação integrada, a Cohab Minas executa projetos com eficiência e responsabilidade, contribuindo para a redução do déficit habitacional e oferecendo soluções completas de política pública sólida, confiável e comprometida com a qualidade.</p>
        </section>

        <section class="reurb-section">
            <h3>CONSULTORIA TÉCNICA</h3>
            <ol class="reurb-list">
                <li>Protocolo de Intenção</li>
                <li>Contratação da Cohab</li>
                <li>Viabilidade do Empreendimento</li>
                <li>Elaboração do Edital</li>
                <li>Credenciamento da Construtora</li>
                <li>Contratação do Empreendimento</li>
            </ol>
        </section>
        ...
        <section class="reurb-section">
            ...
            <ul class="reurb-list">
                <li>Reduzir o déficit habitacional</li>
                <li>Modernizar processos de construção</li>
                <li>Apoiar os municípios</li>
                <li>Acesso à moradia digna</li>
            </ul>
        </section>
        ...
        <section class="reurb-section">
            <h2>CORTESIA – ANÁLISE PRELIMINAR</h2>
            <p>O município encaminha documentação para a Cohab, que realiza uma análise preliminar com base em 3 pilares:</p>
            <ul class="reurb-list">
                <li>Análise prévia da situação jurídica do terreno.</li>
                <li>Análise de viabilidade com indicação da aptidão do terreno (plano de mancha).</li>
                <li>Estudo prévio da demanda social (IBGE).</li>
            </ul>
        </section>
        ...
        <section class="reurb-section">
            <h2>O QUE VOCÊ ESTÁ CONTRATANDO?</h2>
            <p class="reurb-highlight"><strong>Estudo de Viabilidade Social</strong></p>
            <p>Análise da demanda social por meio do levantamento dos interessados, com coleta e consolidação de dados socioeconômicos, considerando a viabilidade do empreendimento, utilizando formulário digital disponibilizado pela Contratada.</p>
            
            <p class="reurb-highlight"><strong>Vistoria do Terreno</strong></p>
            <p>Após a análise da documentação do terreno realizada pelo Contratante, a Contratada realizará vistoria técnica, com engenheiro e arquiteto, para avaliar as condições físicas, ambientais, urbanísticas e de localização da área, bem como a viabilidade da implantação do empreendimento habitacional, subsidiando a análise de viabilidade da implantação do empreendimento.</p>

            <p class="reurb-highlight"><strong>Análise de Viabilidade do Empreendimento Habitacional</strong></p>
            <p>Análise técnica detalhada da viabilidade do empreendimento habitacional, da vistoria e da documentação do terreno, para avaliação técnica, financeira e jurídica da implantação do empreendimento, considerando o perfil dos potenciais compradores.</p>

            <p class="reurb-highlight"><strong>Dossiê do Empreendimento</strong></p>
            <p>Reunião, análise e organização da documentação do empreendimento e do terreno, com verificação de validade e conformidade, consolidação de ajustes quando necessários e posterior apresentação ao agente financeiro.</p>
        </section>
