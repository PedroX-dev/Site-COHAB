...
<head>
    ...
    <title>Como Participar do Progama COHAB Mais Perto</title>
...
<main id="centralizar">
        <span id="titulo">Como Participar do Progama COHAB Mais Perto</span>
        <hr>
        <p>
            O município que tenha interesse em fazer parte do Programa deve firmar um <b>Termo de Parceria com a Companhia</b>, 
            que tem dois anos de duração. Após a consolidação do acordo, <b>o prefeito deve indicar os funcionários para participar da capacitação</b>,
            que se tornam correspondentes da Companhia dentro do município.
            Após o treinamento eles são cadastrados no sistema do <a href="http://cdn.cohab.mg.gov.br/maisperto/open.php" target="_blank"> Cohab Mais Perto</a> e passam a auxiliar e encaminhar as demandas do 
            município referentes aos empreendimentos construídos.
            <br><br>
        </p>
        <p class="centralizarX">
            <b>Para mais informações do programa entre em contato pelo e-mail:</b>
            <br>
            <a href="mailto:maisperto@cohab.mg.gov.br" target="_blank"> maisperto@cohab.mg.gov.br </a>
            <br>
            <b> Ou acesso o link abaixo: </b>
            <br>
            <a href="https://maisperto.cohabmg.com.br/" target="_blank"> Cohab Mais Perto </a>
        </p>
        <hr>
    </main>
