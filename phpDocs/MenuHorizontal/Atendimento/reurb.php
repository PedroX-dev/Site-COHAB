...
<main id="justificar" class="reurb-page">
        <span id="titulo">REURB</span>
        <hr class="reurb-divider">
        <div class="cadastro-reserva">
            <a class="btn-reserva" href="tel:+553139153794" target="_blank" rel="noopener">
                Fale com a Gerência de Atração de Investimentos e Novos Negócios
            </a>
        </div>

        <section class="reurb-section">
            <h2>O QUE É O REURB?</h2>
            <p>A Regularização Fundiária Urbana de Interesse Social (Reurb-S) é uma das ferramentas mais eficientes para mudar o futuro de uma cidade quanto à adequação urbanística, ambiental e jurídica.</p>
            <p>Ela legaliza áreas irregulares ocupadas por famílias de baixa renda, transformando as ocupações informais em bairros oficialmente reconhecidos.</p>
        </section>

        <section class="reurb-section">
            <h3>BENEFÍCIOS DO REURB</h3>
            <p>Regularizar é governar com visão.</p>
            <p>Deixar um legado que muda a história de uma cidade inteira, começando pela porta da casa de quem mais precisa.</p>
            <p><strong>Uma Reurb bem feita:</strong></p>
            <ul class="reurb-list">
                <li>Organiza o território, valoriza os bairros;</li>
                <li>Melhora a infraestrutura da região;</li>
                <li>Aumenta a arrecadação com IPTU;</li>
                <li>Reduz conflitos fundiários;</li>
                <li>Fortalece políticas públicas;</li>
                <li>Melhora a qualidade de vida das famílias.</li>
            </ul>
        </section>
        ...
        <section class="reurb-section">
            ...
            <p>Serviço de gestão do processo completo de regularização fundiária pela Cohab Minas. Isso inclui, além da execução do procedimento, o diagnóstico da área, a conferência de toda a documentação técnica, o acompanhamento do cadastro social e a articulação institucional, tudo para viabilizar a entrega efetiva dos títulos aos moradores.</p>
            <p>A execução do procedimento da Reurb ocorre de forma descentralizada por meio de empresas previamente credenciadas pela Cohab Minas. Isso permite a prestação do serviço com agilidade e em grande escala, abrangendo todas as regiões do Estado de Minas Gerais.</p>
            <p>Nesse processo, a Cohab Minas é parceira do Município em todas as fases do procedimento, do início ao fim. Tudo isso com a expertise de quem conhece profundamente o trabalho e sabe conduzir cada etapa, garantindo a qualidade das entregas.</p>
        </section>

        <hr class="reurb-divider">

        <section class="reurb-section">
            <h2>COMO ACONTECE NA PRÁTICA</h2>
            <p>O processo segue o seguinte fluxo:</p>
            <ul class="reurb-list">
                <li>Análise de viabilidade das áreas indicadas pelo município.</li>
                <li>Credenciamento de fornecedores especializados.</li>
                <li>Contratação da Cohab Minas pelo município.</li>
                <li>Produção da Reurb-S em etapas.</li>
                <li>Gestão e monitoramento técnico pela Cohab Minas.</li>
                <li>Aprovação dos atos pelo município.</li>
                <li>Entrega da Reurb-S, com garantia de moradia digna e inclusão social.</li>
            </ul>
        </section>
        ...
        <section class="reurb-section">
            ...
            <p>Coordenada pela Cohab Minas, a Reurb-S é executada em etapas:</p>
            <ul class="reurb-list">
                <li>Contratação do serviço;</li>
                <li>Execução da regularização fundiária;</li>
                <li>Emissão dos títulos de propriedade.</li>
            </ul>
            <p class="reurb-highlight"><strong>PRAZO TOTAL: ATÉ 18 MESES</strong></p>
        </section>
