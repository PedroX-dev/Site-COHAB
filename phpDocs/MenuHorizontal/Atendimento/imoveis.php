...
<main class="centralizarX">
        <span id="titulo">Imóveis a Venda</span>
        <hr>
        <p>
            A Cohab Minas está comercializando diversas áreas no Estado de Minas Gerais. 
            Atualmente, a Companhia tem imóveis disponíveis para venda em vários municípios mineiros. 
            <div class="cadastro-reserva">
                <a class="btn-reserva" href="https://www.vendascohab.mg.gov.br/" target="_blank">Clique Aqui</a>
            </div>
            <br>
            <b>Para visualizar todas as opções para compra de lotes/áreas da Companhia.</b>
            <br><br>
            Não encontrou o que procura?<br> Clique no botão <b>Entre em Contato</b> para falar no WhastApp com a Cohab Minas e sanar suas dúvidas. 
            <br><br>
            <i>É importante ressaltar que o contato não gera prioridade e nem garantia de aquisição de uma unidade habitacional a ser 
            comercializada pela Cohab Minas e os dados fornecidos são de responsabilidade do (a) interessado (a).</i>
            <div class="cadastro-reserva">
                <a class="btn-reserva" href="https://wa.me/553135014600" target="_blank">Entre em Contato</a>
            </div>
        </p>
        <hr>
</main>
