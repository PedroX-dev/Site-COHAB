...
<head>
    ...
    <title>Liquidação Antecipada</title>
...
<main id="centralizar">
        <span id="titulo">Liquidação Antecipada</span>
        <hr>
        <p>
            <b>A liquidação de contratos junto à Cohab Minas ocorre em uma das duas formas:</b><br> por término de prazo ou por liquidação antecipada.
            <br><br>
            A <b>liquidação por término de prazo</b> é aquela em que o imóvel é quitado após o pagamento da última prestação, de acordo com o contrato de financiamento. 
            <br><br>
            Já a <b>liquidação antecipada </b>é aquela em que o mutuário decide pagar o saldo devedor existente antes do término do prazo contratual. 
            <br><br>Observação: <i>Não existem descontos nas liquidações antecipadas.</i>
        </p>
        <hr>
    </main>
