...
<main id="justificar">
        <span id="titulo">Escrituras</span>
        <hr>
        <p>
            O mutuário receberá conforme seu caso, a <b>Escritura,</b> a <b>Carta de Liberação da Hipoteca (Cohab Minas)</b> ou a <b>Carta de Cancelamento da Propriedade Fiduciária</b> de seu imóvel, <b>após quitar completamente seu financiamento</b>, ou seja, <b>todas as prestações vencidas e/ou vincendas deverão estar quitadas</b>. Lembramos que nos <b>processos de quitação envolvendo sinistro de morte ou invalidez, sua efetivação estará condicionada a indenização do saldo devedor pela Companhia Seguradora</b>.
            <br><br>
            Para a emissão dos documentos finais, serão cobradas as seguintes taxas de emissão:
            <br>
            <ul>
                <li> <b>R$ 150,00</b> (cento e cinquenta reais) para a primeira via do documento final; </li>
                <br>
                <li> <b>R$ 200,00</b> (duzentos reais) para a segunda via do documento final. </li>
                <br>
                <li> <b>R$ 30,00</b> (trinta reais) para a segunda via de liberação de hipoteca e da liberação da caução, desde que estas não tenham sido emitidas, originalmente, em formato digital.</li>
                <br>
            </ul>
            Os emolumentos/despesas decorrentes do registro e/ou da averbação correrão por conta dos interessados.
            <br><br>
            Inicialmente, para a <b>emissão da escritura do imóvel</b>, devem ser enviados à Gerência Habitação/Escrituras, os documentos elencados no link a seguir:
            <br><br>
            <a href="http://www.cohab.mg.gov.br/wp-content/uploads/2025/06/Folder-escritura-9.pdf" target="_blank"> RELAÇÃO DE DOCUMENTOS NECESSÁRIOS À ELABORAÇÃO DA ESCRITURA DO IMÓVEL</a> <b>(Válido também para 2ª via da Escritura)</b>
            <br><br>
            Ficou com alguma dúvida? <a href="http://www.cohab.mg.gov.br/perguntas-frequentes/"target="_blank">Clique Aqui</a> para acessar alguns esclarecimentos sobre todo o processo.
            <br><br>
            <b>Obs.</b>: Esclarecemos que após análise da documentação encaminhada, caso necessário, solicitaremos complementação dos documentos.
