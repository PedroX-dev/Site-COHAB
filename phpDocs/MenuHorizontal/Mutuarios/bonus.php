...
<head>
    ...
    <title>Bônus de Adimplência</title>
...
<main id="justificar">
        <span id="titulo">Bônus de Adimplência</span>
        <hr>
        <p>
            Além dos juros baixos e do prazo longo, <b>todo comprador que adquiriu financiamento habitacional da Cohab Minas após o ano de 2005, 
            que for pontual em sua prestação</b>, receberá, a cada mês em que isso ocorrer, um <b>desconto por meio do bônus de adimplência</b>. 
            O bônus é inédito no país, e o desconto varia de <b>7,8% a 24,5%</b>. Ele é tão maior quanto menor for a renda per capita da família atendida pelo programa.
            <br><br>
            O mutuário, que, por exemplo, tem quatro dependentes e renda de 1 salário-mínimo, ganha 24,5% de desconto na taxa de juros, e a sua prestação mensal baixa de 135,98 para apenas 102,10 reais. Isso permite que o comprador possa cumprir o compromisso assumido em contrato. Mesmo o mutuário com renda de 3 salários-mínimos, e que não tem nenhum dependente, ganha desconto de 7,8% em sua prestação.
        </p>
        <hr>
    </main>
