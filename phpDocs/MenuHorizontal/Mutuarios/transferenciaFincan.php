...
<head>
    ...
    <title>Transferência de Financiamento</title>
...
<main id="justificar">
        <span id="titulo">Transferência de Financiamento</span>
        <hr>
        <p>
            ...
            <br><br>
            São <b>condições necessárias</b> para a realização da transferência do financiamento:
            <ul>
                <li>O financiamento deve estar ativo e emitindo prestações. Ou seja, não é realizada a transferência de contratos quitados.</li>
                <li>O financiamento não pode ter prestações em atraso.</li>
                <li>O cessionário (comprador) não pode ser proprietário ou promitente comprador de imóvel residencial pelo Sistema Financeiro de Habitação – SFH.</li>
                <li>O cessionário não pode possuir restrições junto ao Serviço de Proteção ao Crédito – SPC.</li>
                <li>A renda familiar do cessionário deve ser compatível com o programa habitacional ao qual o imóvel faz parte.</li>
                <li>O cessionário deve ter mais de 18 anos ou ser emancipado.</li>
                <li>A idade do cessionário não poderá ultrapassar 80 anos e 6 meses, ao final do financiamento.</li>
            </ul>
            A solicitação para análise da possibilidade de transferência deve ser enviada para o e-mail: <a href="mailto:transferência@cohab.mg.gov.br">transferência@cohab.mg.gov.br</a>.
            <br><br>
            Observação: <i>Será cobrada no ato da transferência, a tarifa operacional no valor de <b>2%</b> do saldo devedor, que deverá ser paga quando da assinatura do contrato.</i>
