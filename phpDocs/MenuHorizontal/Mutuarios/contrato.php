...
<head>
    ...
    <title>Contrato Cedido ao FIDC</title>
...
<main class="centralizarX">
        <span id="titulo">Contrato Cedido ao FIDC</span>
        <hr>
        <p>
            <img src="imagens/fidc.png" alt="Manual do Mutuário e da Casa Própria">
            <br><br>
            Verifique a seguir se o seu boleto de cobrança sofrerá alteração.
            <br><br>
            <b>Digite o CPF vinculado ao contrato (inserir apenas números, sem ponto e traço):</b>
            <div class="cpf-card">
                <div class="cpf-row">
                    <input type="text" id="cpf-contrato" name="cpf" class="cpf-input" placeholder="Digite o CPF" inputmode="numeric" pattern="[0-9]*" maxlength="11" aria-label="CPF vinculado ao contrato">
                    <button type="button" class="cpf-button" disabled>Consultar</button>
                </div>
            </div>
            <br><br>            
            <i> Observação: Caso seu contrato tenha sido vinculado, seguem os números para contato:</i>
            <br><br>
            <b>Atendimento: FIDC Cohab Minas</b>
            <br>
            <b>WhatsApp:</b> <a href="tel:+5534984274373"> (34) 98427-4373</a>
            <br>
            <b>Tel:</b> <a href="tel:08008300232"> 0800 830 0232</a>
            <br>
            <b>Email:</b> <a href="mailto:atendimento@fundocohabminas.com.br" target="_blank">atendimento@fundocohabminas.com.br</a>
            <br>
            <b>Site:</b> <a href="www.cohabminas.com"> www.cohabminas.com </a>
            <br><br>
            <b>Atendimento:</b> AGS Brasil (Escritura)</b>
            <br>
            <b>WhatsApp:</b> <a href="tel:+5531997660292">(31) 99766-0292</a>
            <br>
            <b>Tel:</b> <a href="tel:+553135867184">(31) 3586-7184</a>
            <br>
            <b>Email:</b> <a href="mailto:escriturascohab@agsbrasil.com.br" target="_blank"> escriturascohab@agsbrasil.com.br</a>
        </p>
        <hr>
    </main>
