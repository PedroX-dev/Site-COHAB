                ...
                <nav class="header-menu header-menu-right" aria-label="Menu principal direito">
                    <ul class="header-menu-list">
                        <li class="header-menu-item">
                            ...
                            <ul class="submenu">
                            <li><a href="segundaViaBoletos.php" target="_blank">2ª Via de Boletos</a></li>
...
<main id="justificar">
        <span id="titulo">Seguros</span>
        <hr>
        <p>
            Nos itens abaixo estão disponibilizadas as plantas dos projetos arquitetônicos, hidrossanitários e elétricos dos padrão habitacionais utilizados pela Cohab Minas desde o ano de 2005.
            <br><br>

            <b>PADRÃO MG-24-AP-2-47 (utilizado desde 2016):</b>
            <br>
            Padrão habitacional do tipo apartamento, em prédio de 04 (quatro) pavimentos, com 04 (quatro) unidades por andar, com cada apartamento composto de 06 (seis) cômodos, sendo uma sala para dois ambientes, dois quartos, hall de circulação, banheiro e cozinha conjugada com a área de serviços, com uma área total, com a alvenaria externa, de 46,88 m², para os imóveis frontais do prédio. Os imóveis de fundo possuem uma pequena diferença de 0,04 m² para menos na área total, em função da divisa com as paredes da área comum de circulação. Os apartamentos térreos posteriores possuem, ainda, uma área privativa de 10,17 m². A área comum do hall e escada, com alvenaria externa, perfaz a metragem de 22,08m² por andar.
            <br><br>
            O apartamento 103, quando houver demanda, será destinado às pessoas com necessidades especiais e terá a porta do banheiro adaptada, bem como as barras e outros equipamentos instalados e adequados ao seu uso.
            <ul>
                <li>Projeto arquitetônico</li>
                <li>Projeto arquitetônico (2)</li>
                <li>Projeto de água</li>
                <li>Projeto de esgoto</li>
                <li>Projeto elétrico</li>
                <li>Projeto elétrico (2)</li>
            </ul>
            <br>

            <b>PADRÃO MG-1-CC-5×5 (utilizado desde 2016):</b>
            <br>
            Padrão de edificação comunitária do tipo centro comunitário, com um único pavimento, composta de um salão, um banheiro, adaptado para portadores de necessidades especiais (PNE) cadeirantes e um ambiente de cozinha com churrasqueira, com um total de 25,00 m².
            <br><br>
            <ul>
                <li>Projeto arquitetônico</li>
                <li>Projeto elétrico</li>
            ...
            <b>PADRÃO MG-91-I-2-45 (utilizado desde 2016):</b>
            <br>
            Padrão habitacional do tipo casa individual, com um único pavimento, composta de 06 (seis) cômodos, sendo uma sala, dois quartos, um hall de circulação, um banheiro, uma cozinha e mais uma área de serviços externa, com um total de 44,78 m².
            <br><br>
            <ul>
                <li>Projeto arquitetônico</li>
                <li>Projeto arquitetônico</li>
            ...
            <b>PADRÃO MG-91-I-2-45 -PNE (utilizado desde 2016):</b>
            Padrão habitacional do tipo casa individual, com um único pavimento, composta de 06 (seis) cômodos, sendo uma sala, dois quartos, um hall de circulação, um banheiro, adaptado para portadores de necessidades especiais (PNE) cadeirantes, uma cozinha e mais uma área de serviços externa, com um total de 44,78 m².
            <br><br>
            <ul>
                <li>Projeto arquitetônico</li>
                <li>Projeto arquitetônico</li>
            ...
            <b>PADRÃO MG-80-I-2-36 (utilizado nos conjuntos habitacionais construídos de 2005 a 2011):</b>
            Este padrão habitacional possui uma área de 36,27 m2, com dois quartos, sala, cozinha, banheiro e área de serviço externa.”
            <br><br>
            <ul>
                <li>Projeto de água</li>
                <li>Projeto arquitetônico</li>
            ...
            <b>PADRÃO MG-90-I-2-41 (utilizado nos conjuntos habitacionais construídos de 2012 a 2015):</b>
            Este padrão habitacional possui uma área de 40,79 m2 , com dois quartos, sala, cozinha, banheiro e área de serviço externa.”
            <br><br>
            <ul>
                <li>Projeto esgoto sanitário</li>
                <li>Projeto elétrico</li>
                <li>Projeto arquitetônico</li>
                <li>Projeto água</li>
            </ul>
