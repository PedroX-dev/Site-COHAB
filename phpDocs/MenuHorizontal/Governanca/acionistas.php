...
<main>
        <span id="titulo">Acionistas</span>
        <hr>
        <p class="centralizarX">
            <img src="imagens/Acionistas.png" alt="LGPD">
            <br>
            A <b>Cohab Minas</b> é uma empresa de <b>economia mista</b>, cujo <b>acionista majoritário</b> é o <b>Estado de Minas Gerais!</b>
            <br><br>
        </p>

        <div class="tabela">
            <div class="item tituloTabela">
                Acionistas
            </div>
            <div class="item tituloTabela">
                Ações
