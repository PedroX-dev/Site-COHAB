...
<head>
    ...
    <title>Carta Anual de Políticas Públicas e Governança Corporativa</title>
...
<main>
        <span id="titulo">Carta Anual de Políticas Públicas e Governança Corporativa</span>
        <hr>
        <section class="estrategia-accordion">
            <p class="estrategia-intro">Abra um ano para visualizar a carta anual correspondente.</p>
            <div id="accordionAnual"></div>
        </section>
        <hr>
    </main>
