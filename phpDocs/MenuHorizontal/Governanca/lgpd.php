...
<main class="centralizarX">
        <span id="titulo">Lei Geral de Proteção de Dados</span>
        <hr>
        <p>
            <img src="imagens/lgpd.png" alt="LGPD">
            <br>
            A Comissão da Lei Geral de Proteção de Dados (LGPD) da Cohab Minas, instituída pela Portaria da Presidência Nº 2693, de 16 de outubro de 2020, tem como objetivo o estudo e o desenvolvimento de metodologia para aplicação da lei no âmbito da Companhia, propondo à Diretoria Executiva ações com o propósito de proteger a privacidade dos dados tratados no âmbito da Cohab Minas. Por meio de seus membros, vem realizando reuniões técnicas regularmente, para a elaboração de propostas de Programa de Implantação da LGPD, bem como, do Plano de Ação para o desenvolvimento da Política de Proteção de Dados Pessoais na Cohab Minas. Neste sentido, a Comissão já desenvolveu uma cartilha, que foi devidamente aprovada pela Diretoria Executiva da Companhia, que apresenta aos seus colaboradores, fornecedores e prestadores de serviços  pontos de atenção e aspectos da Lei. Realizou, ainda, durante uma semana, treinamentos com todo corpo funcional da empresa para esclarecer dúvidas e apontar as principais diretrizes da LGPD.
            <br><br>
            As dúvidas sobre a LGPD podem ser encaminhadas à Comissão para o
            <br><br>
            E-mail: <a href="mailto:lgpd@200.198.20.180"> lgpd@200.198.20.180 </a>
            <br><br>
            <a href="http://www.cohab.mg.gov.br/wp-content/uploads/2021/03/Cartilha-LGPD-2.pdf"> Clique aqui </a> para visualizar a Cartilha LGPD – Cohab Minas
            <br><br>
            <a href="http://www.cohab.mg.gov.br/wp-content/uploads/2021/03/Portaria-2693-2020-1.pdf"> Clique aqui </a> para visualizar a Portaria Nº 2693 – Criação da Comissão LGPD
            <br><br>
            <b>Data Protection Officer (DPO):</b>
            <br>
            Titular: Hudson de Oliveira Cambraia
        </p>
        <hr>
    </main>
