...
<head>
    ...
    <title>Relatório Anual de Auditoria Interna</title>
...
<main>
        <span id="titulo">Relatório Anual de Auditoria Interna</span>
        <hr>
        <section class="estrategia-accordion">
            <p class="estrategia-intro">Abra um período anual para visualizar o Relatório Anual de Auditoria Interna correspondente.</p>
            <div id="accordionRelatorioAUD"></div>
        </section>
        <hr>
    </main>
