...
<head>
    ...
    <title> Estratégias de Negócios</title>
...
<main>
        <span id="titulo">Estratégias de Negócios</span>
        <hr>
        <section class="estrategia-accordion">
            <p class="estrategia-intro">Abra um ano para visualizar os documentos e planos correspondentes.</p>
            <div id="estrategia-accordion"></div>
        </section>
        <hr>
    </main>
