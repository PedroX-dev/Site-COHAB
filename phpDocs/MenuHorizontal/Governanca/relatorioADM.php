...
<head>
    ...
    <title>Relatório Anual de Administração</title>
...
<main>
        <span id="titulo">Relatório de Administração</span>
        <hr>
        <section class="estrategia-accordion">
            <p class="estrategia-intro">Abra um período anual para visualizar o Relatório Anual de Administração Integrado correspondente.</p>
            <div id="accordionRelatorioADM"></div>
        </section>
        <hr>
    </main>
