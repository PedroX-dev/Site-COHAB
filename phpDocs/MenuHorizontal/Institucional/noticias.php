...
<head>
    ...
    <title>Noticias - COHAB Minas</title>
...
<main>
        <span id="titulo">Noticias</span>
        <hr>
        <div id="area-principal" class="noticias-layout">
            <div id="area-postagens">
                <div class="noticias-carousel-controls noticias-carousel-controls--top">
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselNoticias" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </button>
                    <div class="carousel-indicators noticias-indicators">
                        <button type="button" data-bs-target="#carouselNoticias" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Pagina 1"></button>
                        <button type="button" data-bs-target="#carouselNoticias" data-bs-slide-to="1" aria-label="Pagina 2"></button>
                        <button type="button" data-bs-target="#carouselNoticias" data-bs-slide-to="2" aria-label="Pagina 3"></button>
                        <button type="button" data-bs-target="#carouselNoticias" data-bs-slide-to="3" aria-label="Pagina 4"></button>
                        <button type="button" data-bs-target="#carouselNoticias" data-bs-slide-to="4" aria-label="Pagina 5"></button>
                    </div>
                ...
                <div id="carouselNoticias" class="carousel slide noticias-carousel" data-bs-ride="carousel" data-bs-interval="6000">
                    <div class="carousel-inner">

                        <div class="carousel-item active">
                            <article class="postagem">
                                <h2>Obras de urbanizacao avancam em mais 3 bairros</h2>
                                <span class="data-postagem">Postado em 08 de janeiro de 2026</span>
                                <img src="../../imagens/menuNoticias/noticia1.jpg" alt="Moradias em conjunto habitacional">
                                <p>
                                    Equipes concluem drenagem e pavimentacao em tres frentes de trabalho. A entrega esta prevista
                                    para o proximo trimestre, com melhoria no acesso e na seguranca das vias.
                                </p>
                                <a href="#">Leia mais</a>
                            </article>

                            <article class="postagem">
                                <h2>Novo posto de atendimento inicia operacao no interior</h2>
                                <span class="data-postagem">Postado em 04 de janeiro de 2026</span>
                                <img src="../../imagens/menuNoticias/noticia2.jpg" alt="Atendimento em escritorio regional">
                                <p>
                                    A nova unidade amplia o suporte a mutuarios, com orientacao presencial e digital assistida.
                                    O objetivo e reduzir o tempo medio de resposta e facilitar o acesso a servicos essenciais.
                                </p>
                                <a href="#">Leia mais</a>
                            </article>
                        </div>
                        ...
                        <div class="carousel-item">
                            <article class="postagem">
                                <h2>Cadastro de reserva reabre com novas faixas de renda</h2>
                                <span class="data-postagem">Postado em 27 de dezembro de 2025</span>
                                <img src="../../imagens/menuNoticias/noticia3.jpeg" alt="Placa de programa habitacional">
                                <p>
                                    A atualizacao inclui criterios de prioridade e atendimento digital assistido. As inscricoes
                                    podem ser feitas online com apoio das equipes regionais.
                                </p>
                                <a href="#">Leia mais</a>
                            </article>
                ...
                <div class="noticias-carousel-controls noticias-carousel-controls--bottom">
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselNoticias" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </button>
            ...
            <aside id="area-lateral">
                <div class="conteudo-lateral">
                    ...
                    <div class="postagem-lateral">
                        <img src="imagens/Conjuntos.jpg" alt="Conjuntos Habitacionais">
                        <p class="texto-lateral">Plano de obras 2026 recebe novos investimentos.</p>
                        <a href="#">Leia mais</a>
                    </div>
                    <div class="postagem-lateral">
                        <img src="imagens/cidade-administrativa.JPG" alt="Cidade Administrativa">
                        <p class="texto-lateral">Atendimento digital passa a integrar WhatsApp.</p>
                        <a href="#">Leia mais</a>
                    </div>
                </div>
                ...
                <div class="conteudo-lateral">
                    ...
                    <div class="postagem-lateral">
                        <img src="imagens/Conjuntos.jpg" alt="Conjuntos Habitacionais">
                        <p class="texto-lateral">Aviso sobre atualizacao cadastral de mutuarios.</p>
                        <a href="#">Leia mais</a>
                    </div>
                    <div class="postagem-lateral">
                        <img src="imagens/Conjuntos2.jpg" alt="Conjuntos Habitacionais">
                        <p class="texto-lateral">Chamada publica para projetos de habitacao.</p>
                        <a href="#">Leia mais</a>
                    </div>
                </div>
            </aside>
...
<script>
(() => {
  const carousel = document.querySelector('#carouselNoticias');
  if (!carousel) return;

  const indicatorGroups = document.querySelectorAll('.noticias-indicators');

  carousel.addEventListener('slid.bs.carousel', (event) => {
    const index = event.to;
    indicatorGroups.forEach((group) => {
      group.querySelectorAll('[data-bs-target]').forEach((button, i) => {
