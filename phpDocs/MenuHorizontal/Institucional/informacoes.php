...
<head>
    ...
    <title>Informacoes Relevantes - COHAB Minas</title>
...
<main>
        <section class="news-section" aria-label="Informacoes relevantes">
            <div class="news-header">
                <div>
                    <p class="news-kicker">Governanca</p>
            ...
            <div class="news-services">
                <div class="servicos-grid">
                    <a class="servico-card" href="../Transparencia/prestacaoCohab.php">
                        <img src="../../imagens/menuScroll/governanca.svg" alt="Prestacao de Contas COHAB">
                        <span>Prestação de Contas COHAB</span>
                        <p class="servico-desc">Acesse os relatorios e demonstrativos oficiais da companhia.</p>
                    </a>
                    <!-- <div class="servico-card servico-card-placeholder" aria-hidden="true"></div> -->
                </div>
            </div>
            ...
            <div class="news-window">
                    ...
                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia1.jpg" alt="Documento institucional" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Documento</span>
                            <h3>Estatuto Social</h3>
                            <p>Base legal que orienta a organização, as competências e o funcionamento da companhia.</p>
                            <a href="http://www.cohab.mg.gov.br/wp-content/uploads/2025/06/Estatuto-Social-28.04.2025.pdf" class="news-link" target="_blank" rel="noopener">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia2.jpg" alt="Politicas corporativas" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Politicas</span>
                            <h3>Politicas corporativas</h3>
                            <p>Diretrizes de governanca e conduta que orientam as atividades da COHAB Minas.</p>
                            <a href="http://www.cohab.mg.gov.br/wp-content/uploads/2025/07/R-458-2025.pdf" class="news-link" target="_blank" rel="noopener">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia3.jpeg" alt="Programa de integridade" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Integridade</span>
                            <h3>Programa de integridade</h3>
                            <p>Iniciativas e mecanismos de prevencao, deteccao e resposta a riscos de integridade.</p>
                            <a href="../Governanca/integridade.php" class="news-link">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia1.jpg" alt="Codigo de conduta" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Conduta</span>
                            <h3>Codigo de conduta</h3>
                            <p>Principios eticos e compromissos de integridade aplicados a todos os colaboradores.</p>
                            <a href="../Governanca/codigo.php" class="news-link">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia2.jpg" alt="Protecao de dados" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">LGPD</span>
                            <h3>Protecao de dados</h3>
                            <p>Diretrizes sobre tratamento de dados pessoais e canais oficiais de atendimento.</p>
                            <a href="../Governanca/lgpd.php" class="news-link">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia3.jpeg" alt="Carta anual" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Carta anual</span>
                            <h3>Politicas publicas e governanca</h3>
                            <p>Publicacoes anuais com metas, diretrizes e resultados institucionais.</p>
                            <a href="../Governanca/cartaAnual.php" class="news-link">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia1.jpg" alt="Relatorio de administracao" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Relatorios</span>
                            <h3>Relatorio de administracao</h3>
                            <p>Visao consolidada de desempenho, projetos e indicadores de governanca.</p>
                            <a href="../Governanca/relatorioADM.php" class="news-link">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia2.jpg" alt="Relatorio de auditoria interna" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Auditoria</span>
                            <h3>Relatorio anual de auditoria</h3>
                            <p>Documentos que apresentam os trabalhos de auditoria interna e seus resultados.</p>
                            <a href="../Governanca/relatorioAUD.php" class="news-link">Acessar</a>
                        </div>
                    </article>

                    <article class="news-card">
                        <img src="../../imagens/menuNoticias/noticia3.jpeg" alt="Dividendos e acionistas" class="news-thumb">
                        <div class="news-body">
                            <span class="news-tag">Participacoes</span>
                            <h3>Dividendos e acionistas</h3>
                            <p>Informacoes sobre distribuicao de resultados e quadro societario.</p>
                            <a href="../Governanca/dividendos.php" class="news-link">Dividendos</a>
                            <a href="../Governanca/acionistas.php" class="news-link">Acionistas</a>
                        </div>
                    </article>
                </div>

                <div class="news-controls" aria-hidden="true">
                    <button class="news-arrow news-prev" type="button" aria-label="Noticia anterior">&#8592;</button>
                    <div class="news-dots"></div>
                    <button class="news-arrow news-next" type="button" aria-label="Proxima noticia">&#8594;</button>
                </div>
            </div>
        </section>
    </main>
