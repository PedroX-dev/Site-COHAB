...
<main class="centralizarX">
        <span id="titulo">Estrutura Organizacional</span>
        <hr>
        <p>
            A <b>Companhia de Habitação do Estado de Minas Gerais</b> tem sede administrativa em <b>Belo Horizonte</b>, localizada na <b>Cidade Administrativa</b> à <b>Rod. Prefeito Américo Gianetti, s/n°-ED. Gerais- 14° andar</b>. A empresa possui também 01 Escritório Regional, localizado na cidade de <b>Uberlândia</b>.
        </p>
            <img src="imagens/cidade-administrativa.JPG" alt="Cidade Administrativa" id="centralizarIMG">
        <p>
            A <b>Cohab Minas</b> é um órgão vinculado à <b>Secretaria de Estado de Desenvolvimento Econômico(Sede)</b>.
            <br><br>
            A estrutura organizacional da Companhia compõe-se da presidência, vice-presidência e três diretorias. 
        </p>
        <br>
        <p>
            <details>
                <summary>Clique Aqui para visualizar o Organograma da COHAB Minas</summary>
                <img class="centralizarX" src="imagens/Organograma.png" alt="Organograma da empresa">
            </details>
            <br><br>
            Visite também o site da <b>Secretaria de Estado de Desenvolvimento Econômico</b>: <a href="https://desenvolvimento.mg.gov.br/" target="_blank">www.desenvolvimento.mg.gov.br</a>
            <br><br>
        </p>
        <hr>
    </main>
