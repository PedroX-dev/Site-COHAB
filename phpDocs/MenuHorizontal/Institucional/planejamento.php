...
<main id="justificar">
        <span id="titulo">Planejamento Estratégico</span>
        <hr>
        <p>
            <img src="imagens/Planejamento.png" alt="planejamento" id="centralizarIMG">
            <br>
            Em 2024, o planejamento estratégico da Cohab Minas foi revisto e expandido para o universo temporal de 2024 a 2030, cumprindo assim a determinação legal de atualização da estratégia de longo prazo para, no mínimo, os próximos 5 (cinco) anos.
            <br><br>
            A gestão da Cohab Minas segue as diretrizes expressas em seus fundamentos estratégicos: <b>visão, missão, valores e pilares</b>, listados a seguir.
            <br><br>
            <b>MISSÃO</b>: Facilitar o acesso de famílias mineiras de baixa renda à moradia digna, por meio de soluções que garantem autonomia do cidadão com menor dependência do Estado
            <br><br>
            <b>VISÃO</b>: Ser, em 2030, reconhecida pela promoção de moradia digna para famílias de baixa renda em Minas Gerais, mantendo o foco na eficiência operacional, redução de passivos e cumprimento das diretrizes governamentais.
            <br><br>
            <b>VALORES</b>: Agilidade, colaboração, inovação, integridade, respeito aos contratos, responsabilização, transparência, uso racional dos recursos.
            <br><br>
            <b>PILARES</b>: Manter-se independente dos recursos do tesouro; reduzir os custos operacionais ao mínimo; conquistar uma nova realidade na gestão de pessoas; ser mais ágil, sucinta, eficiente e coerente com o contexto, zelando pela integridade, compliance e melhores práticas de governança.
            <br>
        </p>
        <hr>
    </main>
