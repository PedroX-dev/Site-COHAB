...
<main id="justificar">
        <span id="titulo">Conselhos</span>
        <hr>
        <section class="quem-equem">
            <div class="quem-equem-list">
                <div class="quem-equem-content">
            <h5>Conselho de Administração</h5><br>
                    <b>Presidente:</b> <br> 
                    <button type="button" class="pessoa-link" data-foto="imagens/fotosQuemEquem/RicardoGontijo.jpg">Ricardo Augusto de Gontijo Vivian</button><br><br>

            <b>Membros:</b> <br>
            <button type="button" class="pessoa-link" data-foto="imagens/fotosQuemEquem/CelioFilho.jpg">Célio Benício Siqueira Filho</button><br>
            Paulo Henrique Cotta Pacheco<br>
            
            <br><br>

            <h5>Conselho Fiscal</h5><br>

            <b>Membros Titulares:</b><br>
            Hélio Lopes de Oliveira Filho<br>
            Larissa Rodrigues Dias<br>
            Silas Fagundes de Carvalho<br>

            <br><br>

            <b>Membros Suplentes:</b><br>
            

                </div>
            </div>
            <aside class="quem-equem-preview" aria-live="polite">
                <div class="pessoa-placeholder">Passe o mouse ou clique em um nome para ver a foto.</div>
