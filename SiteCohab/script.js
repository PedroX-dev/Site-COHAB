...
// ponto safeXX
  ...
  fonteMaisBotao.innerHTML = '<span class="fonte-icone" aria-hidden="true">+</span><span class="label">Aumentar</span>';
  ...
  fonteMenosBotao.innerHTML = '<span class="fonte-icone" aria-hidden="true">-</span><span class="label">Diminuir</span>';
...
const isQuemEquem = pathLower.includes('quemequem.html') || pathLower.includes('conselhos.html');
  ...
  if (breadcrumbMenu && breadcrumbMain && breadcrumbIsMenu && !document.querySelector('.breadcrumbs')) {
    ...
    const siteRoot = getSiteRoot();
    const homeUrl = new URL('index.html', siteRoot).toString();
    ...
    breadcrumbMenu.insertAdjacentElement('afterend', nav);
  }
